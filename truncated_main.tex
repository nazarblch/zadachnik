...
\include{standart_tasks}

\include{generative_functions}

\include{zb4}

\include{truncated/measure_concentration}
...
\include{truncated/algorithms}

\include{geometric_probability}

\include{sundries} % разное
